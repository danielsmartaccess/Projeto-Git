...
- Contador de tempo
- Logo do SENAC no título e células
"""
...
class MinesweeperApp:
    def __init__(self, master):
        ...
        target_width = 250  # Aumentado para harmonizar com o novo tamanho dos botões
        ...
        self.timer_label = tk.Label(self.master, text="Tempo: 0s", font=("Arial", 20))  # Fonte aumentada para 20
        self.timer_label.grid(row=1, column=0, columnspan=9, pady=10)
    ...
    def create_widgets(self):
        ...
        for r in range(self.grid.rows):
            ...
            for c in range(self.grid.cols):
                btn = tk.Button(self.master, **button_style)
        ...
        for r in range(self.grid.rows):
            for c in range(self.grid.cols):
                ...
                if cell.state == "revealed":
                    if cell.has_mine:
                        button.config(relief=tk.SUNKEN, text="💣", background="red")
                        ...
                        button.config(relief=tk.SUNKEN, text="")
                elif cell.state == "flagged":
                    button.config(relief=tk.RAISED, text="🚩")
                else:
                    button.config(relief=tk.RAISED, text="")
